...
class modsDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, modsDefinition)
    ...
    def hasContent_(self):
        if (
            ...
            or self.originInfo
            or self.part
            or self.physicalDescription
            or self.recordInfo
            or self.relatedItem
            or self.subject
            or self.tableOfContents
            or self.targetAudience
            or self.titleInfo
            or self.typeOfResource
        ):
            return True
        else:
            return False
    ...
    def export(
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="modsDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(
        ...
        for abstract_ in self.abstract:
            ...
            abstract_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="abstract", pretty_print=pretty_print
            )
        for accessCondition_ in self.accessCondition:
            namespaceprefix_ = (
                self.accessCondition_nsprefix_ + ":" if (UseCapturedNS_ and self.accessCondition_nsprefix_) else ""
            )
            accessCondition_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="accessCondition", pretty_print=pretty_print
            )
        for classification_ in self.classification:
            namespaceprefix_ = (
                self.classification_nsprefix_ + ":" if (UseCapturedNS_ and self.classification_nsprefix_) else ""
            )
            classification_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="classification", pretty_print=pretty_print
            )
        for extension_ in self.extension:
            ...
            extension_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="extension", pretty_print=pretty_print
            )
        ...
        for location_ in self.location:
            ...
            location_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="location", pretty_print=pretty_print
            )
        ...
        for originInfo_ in self.originInfo:
            ...
            originInfo_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="originInfo", pretty_print=pretty_print
            )
        ...
        for physicalDescription_ in self.physicalDescription:
            namespaceprefix_ = (
                self.physicalDescription_nsprefix_ + ":"
                if (UseCapturedNS_ and self.physicalDescription_nsprefix_)
                else ""
            )
            physicalDescription_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="physicalDescription",
        ...
        for recordInfo_ in self.recordInfo:
            ...
            recordInfo_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="recordInfo", pretty_print=pretty_print
            )
        for relatedItem_ in self.relatedItem:
            namespaceprefix_ = (
                self.relatedItem_nsprefix_ + ":" if (UseCapturedNS_ and self.relatedItem_nsprefix_) else ""
            )
            relatedItem_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="relatedItem", pretty_print=pretty_print
            )
        for subject_ in self.subject:
            namespaceprefix_ = self.subject_nsprefix_ + ":" if (UseCapturedNS_ and self.subject_nsprefix_) else ""
            subject_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="subject", pretty_print=pretty_print
            )
        for tableOfContents_ in self.tableOfContents:
            namespaceprefix_ = (
                self.tableOfContents_nsprefix_ + ":" if (UseCapturedNS_ and self.tableOfContents_nsprefix_) else ""
            )
            tableOfContents_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="tableOfContents", pretty_print=pretty_print
            )
        for targetAudience_ in self.targetAudience:
            namespaceprefix_ = (
                self.targetAudience_nsprefix_ + ":" if (UseCapturedNS_ and self.targetAudience_nsprefix_) else ""
            )
            targetAudience_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="targetAudience", pretty_print=pretty_print
            )
        for titleInfo_ in self.titleInfo:
            ...
            titleInfo_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="titleInfo", pretty_print=pretty_print
            )
        for typeOfResource_ in self.typeOfResource:
            namespaceprefix_ = (
                self.typeOfResource_nsprefix_ + ":" if (UseCapturedNS_ and self.typeOfResource_nsprefix_) else ""
            )
            typeOfResource_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="typeOfResource", pretty_print=pretty_print
            )
...
class modsCollectionDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, modsCollectionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="modsCollectionDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="modsCollectionDefinition"
    ):
        pass
...
class extensionDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, extensionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.anytypeobjs_ or (1 if type(self.valueOf_) in [int, float] else self.valueOf_):
            return True
        else:
            return False
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="extensionDefinition"):
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            ...
            outfile.write(
                " displayLabel=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.displayLabel), input_name="displayLabel")),)
            )
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == "":
            ...
            obj_.build(child_, gds_collector_=gds_collector_)
            obj_ = self.mixedclass_(MixedContainer.CategoryComplex, MixedContainer.TypeNone, "", obj_)
            self.content_.append(obj_)
...
class languageDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, languageDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.languageTerm or self.scriptTerm:
            return True
        else:
            return False
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="languageDefinition"):
        if self.objectPart is not None and "objectPart" not in already_processed:
            ...
            outfile.write(
                " objectPart=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.objectPart), input_name="objectPart")),)
            )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.altRepGroup is not None and "altRepGroup" not in already_processed:
            ...
            outfile.write(
                " altRepGroup=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.altRepGroup), input_name="altRepGroup")),)
            )
        if self.usage != "primary" and "usage" not in already_processed:
            already_processed.add("usage")
            outfile.write(
                " usage=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.usage), input_name="usage")),)
            )
        if self.lang is not None and "lang" not in already_processed:
            already_processed.add("lang")
            outfile.write(
                " lang=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.lang), input_name="lang")),)
            )
        if self.lang is not None and "lang" not in already_processed:
            already_processed.add("lang")
            outfile.write(
        ...
        if self.script is not None and "script" not in already_processed:
            ...
            outfile.write(
                " script=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.script), input_name="script")),)
            )
        if self.transliteration is not None and "transliteration" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.transliteration), input_name="transliteration")
                    ),
                )
            )
    ...
    def exportChildren(
        ...
        for languageTerm_ in self.languageTerm:
            namespaceprefix_ = (
                self.languageTerm_nsprefix_ + ":" if (UseCapturedNS_ and self.languageTerm_nsprefix_) else ""
            )
            languageTerm_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="languageTerm", pretty_print=pretty_print
            )
        for scriptTerm_ in self.scriptTerm:
            ...
            scriptTerm_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="scriptTerm", pretty_print=pretty_print
            )
...
class locationDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, locationDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            self.physicalLocation
            or self.shelfLocator
            or self.url
            or self.holdingSimple is not None
            or self.holdingExternal is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(
        ...
        for physicalLocation_ in self.physicalLocation:
            namespaceprefix_ = (
                self.physicalLocation_nsprefix_ + ":" if (UseCapturedNS_ and self.physicalLocation_nsprefix_) else ""
            )
            physicalLocation_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="physicalLocation", pretty_print=pretty_print
            )
        for shelfLocator_ in self.shelfLocator:
            namespaceprefix_ = (
                self.shelfLocator_nsprefix_ + ":" if (UseCapturedNS_ and self.shelfLocator_nsprefix_) else ""
            )
            shelfLocator_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="shelfLocator", pretty_print=pretty_print
            )
        ...
        if self.holdingSimple is not None:
            namespaceprefix_ = (
                self.holdingSimple_nsprefix_ + ":" if (UseCapturedNS_ and self.holdingSimple_nsprefix_) else ""
            )
            self.holdingSimple.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="holdingSimple", pretty_print=pretty_print
            )
        if self.holdingExternal is not None:
            namespaceprefix_ = (
                self.holdingExternal_nsprefix_ + ":" if (UseCapturedNS_ and self.holdingExternal_nsprefix_) else ""
            )
            self.holdingExternal.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="holdingExternal", pretty_print=pretty_print
            )
...
class holdingSimpleDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, holdingSimpleDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def exportChildren(
        ...
        for copyInformation_ in self.copyInformation:
            namespaceprefix_ = (
                self.copyInformation_nsprefix_ + ":" if (UseCapturedNS_ and self.copyInformation_nsprefix_) else ""
            )
            copyInformation_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="copyInformation", pretty_print=pretty_print
            )
...
class copyInformationDefinition(GeneratedsSuper):
    ...
    def __init__(
        ...
        subLocation=None,
        shelfLocator=None,
        electronicLocator=None,
        note=None,
        enumerationAndChronology=None,
        itemIdentifier=None,
        gds_collector_=None,
        **kwargs_,
    ):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, copyInformationDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            or self.subLocation
            or self.shelfLocator
            or self.electronicLocator
            or self.note
            or self.enumerationAndChronology
            or self.itemIdentifier
        ):
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="copyInformationDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="copyInformationDefinition"
    ):
        pass
    ...
    def exportChildren(
        ...
        if self.form is not None:
            ...
            self.form.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="form", pretty_print=pretty_print
            )
        for subLocation_ in self.subLocation:
            namespaceprefix_ = (
                self.subLocation_nsprefix_ + ":" if (UseCapturedNS_ and self.subLocation_nsprefix_) else ""
            )
            subLocation_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="subLocation", pretty_print=pretty_print
            )
        for shelfLocator_ in self.shelfLocator:
            namespaceprefix_ = (
                self.shelfLocator_nsprefix_ + ":" if (UseCapturedNS_ and self.shelfLocator_nsprefix_) else ""
        ...
        for electronicLocator_ in self.electronicLocator:
            namespaceprefix_ = (
                self.electronicLocator_nsprefix_ + ":" if (UseCapturedNS_ and self.electronicLocator_nsprefix_) else ""
            )
            electronicLocator_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="electronicLocator", pretty_print=pretty_print
            )
        for note_ in self.note:
            namespaceprefix_ = self.note_nsprefix_ + ":" if (UseCapturedNS_ and self.note_nsprefix_) else ""
            note_.export(outfile, level, namespaceprefix_, namespacedef_="", name_="note", pretty_print=pretty_print)
        for enumerationAndChronology_ in self.enumerationAndChronology:
            namespaceprefix_ = (
                self.enumerationAndChronology_nsprefix_ + ":"
                if (UseCapturedNS_ and self.enumerationAndChronology_nsprefix_)
                else ""
            )
            enumerationAndChronology_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="enumerationAndChronology",
                pretty_print=pretty_print,
            )
        for itemIdentifier_ in self.itemIdentifier:
            namespaceprefix_ = (
                self.itemIdentifier_nsprefix_ + ":" if (UseCapturedNS_ and self.itemIdentifier_nsprefix_) else ""
            )
            itemIdentifier_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="itemIdentifier", pretty_print=pretty_print
            )
...
class urlDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, urlDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="urlDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="urlDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="urlDefinition"):
        if self.dateLastAccessed is not None and "dateLastAccessed" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.dateLastAccessed), input_name="dateLastAccessed")
                    ),
                )
            )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
        ...
        if self.note is not None and "note" not in already_processed:
            ...
            outfile.write(
                " note=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.note), input_name="note")),)
            )
        if self.access is not None and "access" not in already_processed:
            already_processed.add("access")
            outfile.write(
                " access=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.access), input_name="access")),)
            )
...
class nameDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, nameDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            self.namePart
            or self.displayForm
            or self.nameIdentifier
            or self.alternativeName
            or self.etal is not None
            or self.affiliation
            or self.role
            or self.description
        ):
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="nameDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="nameDefinition"):
        ...
        if self.nameTitleGroup is not None and "nameTitleGroup" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.nameTitleGroup), input_name="nameTitleGroup")
                    ),
                )
            )
        if self.usage != "primary" and "usage" not in already_processed:
        ...
        if self.authorityURI is not None and "authorityURI" not in already_processed:
            ...
            outfile.write(
                " authorityURI=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.authorityURI), input_name="authorityURI")),)
            )
        if self.valueURI is not None and "valueURI" not in already_processed:
            already_processed.add("valueURI")
            outfile.write(
                " valueURI=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.valueURI), input_name="valueURI")),)
            )
        if self.type_ != "simple" and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(" type=%s" % (quote_attrib(self.type_),))
    ...
    def exportChildren(
        ...
        for namePart_ in self.namePart:
            ...
            namePart_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="namePart", pretty_print=pretty_print
            )
        for displayForm_ in self.displayForm:
            namespaceprefix_ = (
                self.displayForm_nsprefix_ + ":" if (UseCapturedNS_ and self.displayForm_nsprefix_) else ""
            )
            displayForm_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="displayForm", pretty_print=pretty_print
            )
        for nameIdentifier_ in self.nameIdentifier:
            namespaceprefix_ = (
                self.nameIdentifier_nsprefix_ + ":" if (UseCapturedNS_ and self.nameIdentifier_nsprefix_) else ""
            )
            nameIdentifier_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="nameIdentifier", pretty_print=pretty_print
            )
        for alternativeName_ in self.alternativeName:
            namespaceprefix_ = (
                self.alternativeName_nsprefix_ + ":" if (UseCapturedNS_ and self.alternativeName_nsprefix_) else ""
            )
            alternativeName_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="alternativeName", pretty_print=pretty_print
            )
        if self.etal is not None:
            namespaceprefix_ = self.etal_nsprefix_ + ":" if (UseCapturedNS_ and self.etal_nsprefix_) else ""
            self.etal.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="etal", pretty_print=pretty_print
            )
        for affiliation_ in self.affiliation:
            namespaceprefix_ = (
                self.affiliation_nsprefix_ + ":" if (UseCapturedNS_ and self.affiliation_nsprefix_) else ""
            )
            affiliation_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="affiliation", pretty_print=pretty_print
            )
...
class roleDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, roleDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="roleDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(
        ...
        for roleTerm_ in self.roleTerm:
            ...
            roleTerm_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="roleTerm", pretty_print=pretty_print
            )
...
class alternativeNameDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, alternativeNameDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="alternativeNameDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="alternativeNameDefinition"
    ):
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.altType is not None and "altType" not in already_processed:
            ...
            outfile.write(
                " altType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.altType), input_name="altType")),)
            )
        if self.type_ != "simple" and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(" type=%s" % (quote_attrib(self.type_),))
...
class originInfoDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, originInfoDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            or self.dateIssued
            or self.dateCreated
            or self.dateCaptured
            or self.dateValid
            or self.dateModified
            or self.copyrightDate
            or self.dateOther
            or self.edition
            or self.issuance
            or self.frequency
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="originInfoDefinition"):
        ...
        if self.eventType is not None and "eventType" not in already_processed:
            ...
            outfile.write(
                " eventType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.eventType), input_name="eventType")),)
            )
        if self.lang is not None and "lang" not in already_processed:
            already_processed.add("lang")
            outfile.write(
    ...
    def exportChildren(
        ...
        for publisher_ in self.publisher:
            ...
            publisher_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="publisher", pretty_print=pretty_print
            )
        for dateIssued_ in self.dateIssued:
            ...
            dateIssued_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateIssued", pretty_print=pretty_print
            )
        for dateCreated_ in self.dateCreated:
            namespaceprefix_ = (
                self.dateCreated_nsprefix_ + ":" if (UseCapturedNS_ and self.dateCreated_nsprefix_) else ""
            )
            dateCreated_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateCreated", pretty_print=pretty_print
            )
        for dateCaptured_ in self.dateCaptured:
            namespaceprefix_ = (
                self.dateCaptured_nsprefix_ + ":" if (UseCapturedNS_ and self.dateCaptured_nsprefix_) else ""
            )
            dateCaptured_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateCaptured", pretty_print=pretty_print
            )
        for dateValid_ in self.dateValid:
            ...
            dateValid_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateValid", pretty_print=pretty_print
            )
        for dateModified_ in self.dateModified:
            namespaceprefix_ = (
                self.dateModified_nsprefix_ + ":" if (UseCapturedNS_ and self.dateModified_nsprefix_) else ""
            )
            dateModified_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateModified", pretty_print=pretty_print
            )
        for copyrightDate_ in self.copyrightDate:
            namespaceprefix_ = (
                self.copyrightDate_nsprefix_ + ":" if (UseCapturedNS_ and self.copyrightDate_nsprefix_) else ""
            )
            copyrightDate_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="copyrightDate", pretty_print=pretty_print
            )
        for dateOther_ in self.dateOther:
            ...
            dateOther_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="dateOther", pretty_print=pretty_print
            )
        for edition_ in self.edition:
            namespaceprefix_ = self.edition_nsprefix_ + ":" if (UseCapturedNS_ and self.edition_nsprefix_) else ""
            edition_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="edition", pretty_print=pretty_print
            )
        for issuance_ in self.issuance:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write(
                "<%sissuance>%s</%sissuance>%s"
                % (
                    namespaceprefix_,
                    self.gds_encode(self.gds_format_string(quote_xml(issuance_), input_name="issuance")),
                    namespaceprefix_,
                    eol_,
                )
            )
        for frequency_ in self.frequency:
            ...
            frequency_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="frequency", pretty_print=pretty_print
            )
...
class placeDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, placeDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="placeDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="placeDefinition"):
        if self.supplied != "yes" and "supplied" not in already_processed:
            ...
            outfile.write(
                " supplied=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.supplied), input_name="supplied")),)
            )
    ...
    def exportChildren(
        ...
        for placeTerm_ in self.placeTerm:
            ...
            placeTerm_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="placeTerm", pretty_print=pretty_print
            )
...
class partDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, partDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.detail or self.extent or self.date or self.text:
            return True
        else:
            return False
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="partDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(
        ...
        for detail_ in self.detail:
            ...
            detail_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="detail", pretty_print=pretty_print
            )
        for extent_ in self.extent:
            namespaceprefix_ = self.extent_nsprefix_ + ":" if (UseCapturedNS_ and self.extent_nsprefix_) else ""
            extent_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="extent", pretty_print=pretty_print
            )
...
class detailDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, detailDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.number or self.caption or self.title:
            return True
        else:
            return False
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="detailDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(
        ...
        for number_ in self.number:
            ...
            number_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="number", pretty_print=pretty_print
            )
...
class extentDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, extentDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.start is not None or self.end is not None or self.total is not None or self.list is not None:
            return True
        else:
            return False
    ...
    def export(
        ...
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="extentDefinition", pretty_print=pretty_print
            )
            showIndent(outfile, level, pretty_print)
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(
        ...
        if self.start is not None:
            ...
            self.start.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="start", pretty_print=pretty_print
            )
        ...
        if self.list is not None:
            ...
            self.list.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="list", pretty_print=pretty_print
            )
...
class physicalDescriptionDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, physicalDescriptionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            self.form
            or self.reformattingQuality
            or self.internetMediaType
            or self.extent
            or self.digitalOrigin
            or self.note
        ):
            return True
        else:
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="physicalDescriptionDefinition",
        pretty_print=True,
    ):
        ...
        self.exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="physicalDescriptionDefinition"
        )
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="physicalDescriptionDefinition"
    ):
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        for reformattingQuality_ in self.reformattingQuality:
            namespaceprefix_ = (
                self.reformattingQuality_nsprefix_ + ":"
                if (UseCapturedNS_ and self.reformattingQuality_nsprefix_)
                else ""
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                "<%sreformattingQuality>%s</%sreformattingQuality>%s"
                % (
                    namespaceprefix_,
                    self.gds_encode(
                        self.gds_format_string(quote_xml(reformattingQuality_), input_name="reformattingQuality")
                    ),
                    namespaceprefix_,
                    eol_,
                )
        ...
        for internetMediaType_ in self.internetMediaType:
            namespaceprefix_ = (
                self.internetMediaType_nsprefix_ + ":" if (UseCapturedNS_ and self.internetMediaType_nsprefix_) else ""
            )
            internetMediaType_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="internetMediaType", pretty_print=pretty_print
            )
        for extent_ in self.extent:
            namespaceprefix_ = self.extent_nsprefix_ + ":" if (UseCapturedNS_ and self.extent_nsprefix_) else ""
            extent_.export(
        ...
        for digitalOrigin_ in self.digitalOrigin:
            namespaceprefix_ = (
                self.digitalOrigin_nsprefix_ + ":" if (UseCapturedNS_ and self.digitalOrigin_nsprefix_) else ""
            )
            showIndent(outfile, level, pretty_print)
            outfile.write(
                "<%sdigitalOrigin>%s</%sdigitalOrigin>%s"
                % (
                    namespaceprefix_,
                    self.gds_encode(self.gds_format_string(quote_xml(digitalOrigin_), input_name="digitalOrigin")),
                    namespaceprefix_,
                    eol_,
                )
            )
...
class recordInfoDefinition(GeneratedsSuper):
    ...
    def __init__(
        ...
        script=None,
        transliteration=None,
        recordContentSource=None,
        recordCreationDate=None,
        recordChangeDate=None,
        recordIdentifier=None,
        languageOfCataloging=None,
        recordOrigin=None,
        descriptionStandard=None,
        recordInfoNote=None,
        gds_collector_=None,
        **kwargs_,
    ):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, recordInfoDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            self.recordContentSource
            or self.recordCreationDate
            or self.recordChangeDate
            or self.recordIdentifier
            or self.languageOfCataloging
            or self.recordOrigin
            or self.descriptionStandard
            or self.recordInfoNote
        ):
            return True
        else:
            return False
    ...
    def exportChildren(
        ...
        for recordContentSource_ in self.recordContentSource:
            namespaceprefix_ = (
                self.recordContentSource_nsprefix_ + ":"
                if (UseCapturedNS_ and self.recordContentSource_nsprefix_)
                else ""
            )
            recordContentSource_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="recordContentSource",
                pretty_print=pretty_print,
            )
        for recordCreationDate_ in self.recordCreationDate:
            namespaceprefix_ = (
                self.recordCreationDate_nsprefix_ + ":"
                if (UseCapturedNS_ and self.recordCreationDate_nsprefix_)
                else ""
            )
            recordCreationDate_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="recordCreationDate",
                pretty_print=pretty_print,
            )
        for recordChangeDate_ in self.recordChangeDate:
            namespaceprefix_ = (
                self.recordChangeDate_nsprefix_ + ":" if (UseCapturedNS_ and self.recordChangeDate_nsprefix_) else ""
            )
            recordChangeDate_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="recordChangeDate", pretty_print=pretty_print
            )
        for recordIdentifier_ in self.recordIdentifier:
            namespaceprefix_ = (
                self.recordIdentifier_nsprefix_ + ":" if (UseCapturedNS_ and self.recordIdentifier_nsprefix_) else ""
            )
            recordIdentifier_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="recordIdentifier", pretty_print=pretty_print
            )
        for languageOfCataloging_ in self.languageOfCataloging:
            namespaceprefix_ = (
                self.languageOfCataloging_nsprefix_ + ":"
                if (UseCapturedNS_ and self.languageOfCataloging_nsprefix_)
                else ""
            )
            languageOfCataloging_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="languageOfCataloging",
                pretty_print=pretty_print,
            )
        for recordOrigin_ in self.recordOrigin:
            namespaceprefix_ = (
                self.recordOrigin_nsprefix_ + ":" if (UseCapturedNS_ and self.recordOrigin_nsprefix_) else ""
            )
            recordOrigin_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="recordOrigin", pretty_print=pretty_print
            )
        for descriptionStandard_ in self.descriptionStandard:
            namespaceprefix_ = (
                self.descriptionStandard_nsprefix_ + ":"
                if (UseCapturedNS_ and self.descriptionStandard_nsprefix_)
                else ""
            )
            descriptionStandard_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="descriptionStandard",
                pretty_print=pretty_print,
            )
        for recordInfoNote_ in self.recordInfoNote:
            namespaceprefix_ = (
                self.recordInfoNote_nsprefix_ + ":" if (UseCapturedNS_ and self.recordInfoNote_nsprefix_) else ""
            )
            recordInfoNote_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="recordInfoNote", pretty_print=pretty_print
            )
...
class relatedItemDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, relatedItemDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="relatedItemDefinition"):
        ...
        if self.otherTypeAuth is not None and "otherTypeAuth" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.otherTypeAuth), input_name="otherTypeAuth")
                    ),
                )
            )
        if self.otherTypeAuthURI is not None and "otherTypeAuthURI" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.otherTypeAuthURI), input_name="otherTypeAuthURI")
                    ),
                )
            )
        if self.otherTypeURI is not None and "otherTypeURI" not in already_processed:
            ...
            outfile.write(
                " otherTypeURI=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.otherTypeURI), input_name="otherTypeURI")),)
            )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
...
class subjectDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, subjectDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            or self.titleInfo
            or self.name
            or self.geographicCode
            or self.hierarchicalGeographic
            or self.cartographics
            or self.occupation
            or self.genre
        ):
            return True
    ...
    def exportChildren(
        ...
        for geographic_ in self.geographic:
            ...
            geographic_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="geographic", pretty_print=pretty_print
            )
        for temporal_ in self.temporal:
            ...
            temporal_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="temporal", pretty_print=pretty_print
            )
        for titleInfo_ in self.titleInfo:
            namespaceprefix_ = self.titleInfo_nsprefix_ + ":" if (UseCapturedNS_ and self.titleInfo_nsprefix_) else ""
            titleInfo_.export(
        ...
        for geographicCode_ in self.geographicCode:
            namespaceprefix_ = (
                self.geographicCode_nsprefix_ + ":" if (UseCapturedNS_ and self.geographicCode_nsprefix_) else ""
            )
            geographicCode_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="geographicCode", pretty_print=pretty_print
            )
        for hierarchicalGeographic_ in self.hierarchicalGeographic:
            namespaceprefix_ = (
                self.hierarchicalGeographic_nsprefix_ + ":"
                if (UseCapturedNS_ and self.hierarchicalGeographic_nsprefix_)
                else ""
            )
            hierarchicalGeographic_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="hierarchicalGeographic",
                pretty_print=pretty_print,
            )
        for cartographics_ in self.cartographics:
            namespaceprefix_ = (
                self.cartographics_nsprefix_ + ":" if (UseCapturedNS_ and self.cartographics_nsprefix_) else ""
            )
            cartographics_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="cartographics", pretty_print=pretty_print
            )
        for occupation_ in self.occupation:
            ...
            occupation_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="occupation", pretty_print=pretty_print
            )
        for genre_ in self.genre:
            namespaceprefix_ = self.genre_nsprefix_ + ":" if (UseCapturedNS_ and self.genre_nsprefix_) else ""
            genre_.export(outfile, level, namespaceprefix_, namespacedef_="", name_="genre", pretty_print=pretty_print)
...
class subjectTitleInfoDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, subjectTitleInfoDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.title or self.subTitle or self.partNumber or self.partName or self.nonSort:
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="subjectTitleInfoDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="subjectTitleInfoDefinition"
    ):
        if self.ID is not None and "ID" not in already_processed:
            already_processed.add("ID")
            outfile.write(" ID=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.ID), input_name="ID")),))
    ...
    def exportChildren(
        ...
        for subTitle_ in self.subTitle:
            ...
            subTitle_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="subTitle", pretty_print=pretty_print
            )
        for partNumber_ in self.partNumber:
            ...
            partNumber_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="partNumber", pretty_print=pretty_print
            )
        for partName_ in self.partName:
            ...
            partName_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="partName", pretty_print=pretty_print
            )
        for nonSort_ in self.nonSort:
            namespaceprefix_ = self.nonSort_nsprefix_ + ":" if (UseCapturedNS_ and self.nonSort_nsprefix_) else ""
            nonSort_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="nonSort", pretty_print=pretty_print
            )
...
class subjectNameDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, subjectNameDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
...
class hierarchicalGeographicDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, hierarchicalGeographicDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ',
        name_="hierarchicalGeographicDefinition",
        pretty_print=True,
    ):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="hierarchicalGeographicDefinition"
        )
        if self.hasContent_():
            outfile.write(">%s" % (eol_,))
            self.exportChildren(
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="hierarchicalGeographicDefinition"
    ):
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
            outfile.write(
    ...
    def exportChildren(
        ...
        for extraTerrestrialArea_ in self.extraTerrestrialArea:
            namespaceprefix_ = (
                self.extraTerrestrialArea_nsprefix_ + ":"
                if (UseCapturedNS_ and self.extraTerrestrialArea_nsprefix_)
                else ""
            )
            extraTerrestrialArea_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="extraTerrestrialArea",
                pretty_print=pretty_print,
            )
        for continent_ in self.continent:
            ...
            continent_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="continent", pretty_print=pretty_print
            )
        for country_ in self.country:
            namespaceprefix_ = self.country_nsprefix_ + ":" if (UseCapturedNS_ and self.country_nsprefix_) else ""
            country_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="country", pretty_print=pretty_print
            )
        for province_ in self.province:
            ...
            province_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="province", pretty_print=pretty_print
            )
        ...
        for territory_ in self.territory:
            ...
            territory_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="territory", pretty_print=pretty_print
            )
        for county_ in self.county:
            namespaceprefix_ = self.county_nsprefix_ + ":" if (UseCapturedNS_ and self.county_nsprefix_) else ""
            county_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="county", pretty_print=pretty_print
            )
        ...
        for citySection_ in self.citySection:
            namespaceprefix_ = (
                self.citySection_nsprefix_ + ":" if (UseCapturedNS_ and self.citySection_nsprefix_) else ""
            )
            citySection_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="citySection", pretty_print=pretty_print
            )
        for island_ in self.island:
            namespaceprefix_ = self.island_nsprefix_ + ":" if (UseCapturedNS_ and self.island_nsprefix_) else ""
            island_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="island", pretty_print=pretty_print
            )
...
class cartographicsDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, cartographicsDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if self.scale is not None or self.projection is not None or self.coordinates or self.cartographicExtension:
            return True
        else:
            return False
    ...
    def exportChildren(
        ...
        if self.scale is not None:
            ...
            self.scale.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="scale", pretty_print=pretty_print
            )
        if self.projection is not None:
            namespaceprefix_ = self.projection_nsprefix_ + ":" if (UseCapturedNS_ and self.projection_nsprefix_) else ""
            self.projection.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="projection", pretty_print=pretty_print
            )
        for coordinates_ in self.coordinates:
            namespaceprefix_ = (
                self.coordinates_nsprefix_ + ":" if (UseCapturedNS_ and self.coordinates_nsprefix_) else ""
            )
            coordinates_.export(
                outfile, level, namespaceprefix_, namespacedef_="", name_="coordinates", pretty_print=pretty_print
            )
        for cartographicExtension_ in self.cartographicExtension:
            namespaceprefix_ = (
                self.cartographicExtension_nsprefix_ + ":"
                if (UseCapturedNS_ and self.cartographicExtension_nsprefix_)
                else ""
            )
            cartographicExtension_.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
                name_="cartographicExtension",
                pretty_print=pretty_print,
            )
...
class titleInfoDefinition(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, titleInfoDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="titleInfoDefinition"):
        ...
        if self.altFormat is not None and "altFormat" not in already_processed:
            ...
            outfile.write(
                " altFormat=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.altFormat), input_name="altFormat")),)
            )
        if self.contentType is not None and "contentType" not in already_processed:
            already_processed.add("contentType")
            outfile.write(
                " contentType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.contentType), input_name="contentType")),)
            )
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
            outfile.write(
...
class stringPlusLanguage(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, stringPlusLanguage)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="stringPlusLanguage", pretty_print=True
    ):
...
class stringPlusLanguagePlusAuthority(stringPlusLanguage):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(stringPlusLanguagePlusAuthority, self).__init__(
            lang, script, transliteration, valueOf_, extensiontype_, **kwargs_
        )
        self.authority = _cast(None, authority)
        self.authority_nsprefix_ = None
        self.authorityURI = _cast(None, authorityURI)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, stringPlusLanguagePlusAuthority)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            stringPlusLanguagePlusAuthority, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="stringPlusLanguagePlusAuthority",
        pretty_print=True,
    ):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="stringPlusLanguagePlusAuthority"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="stringPlusLanguagePlusAuthority"
    ):
        super(stringPlusLanguagePlusAuthority, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="stringPlusLanguagePlusAuthority"
        )
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
    ...
    def exportChildren(
        ...
        super(stringPlusLanguagePlusAuthority, self).exportChildren(
...
class stringPlusLanguagePlusSupplied(stringPlusLanguage):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(stringPlusLanguagePlusSupplied, self).__init__(
            lang, script, transliteration, valueOf_, extensiontype_, **kwargs_
        )
        self.supplied = _cast(None, supplied)
        self.supplied_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, stringPlusLanguagePlusSupplied)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            stringPlusLanguagePlusSupplied, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="stringPlusLanguagePlusSupplied",
        pretty_print=True,
    ):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="stringPlusLanguagePlusSupplied"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="stringPlusLanguagePlusSupplied"
    ):
        super(stringPlusLanguagePlusSupplied, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="stringPlusLanguagePlusSupplied"
        )
        if self.supplied != "yes" and "supplied" not in already_processed:
            already_processed.add("supplied")
    ...
    def exportChildren(
        ...
        super(stringPlusLanguagePlusSupplied, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class noteType(stringPlusLanguage):
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(noteType, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="noteType", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="noteType", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportChildren(
        ...
        super(noteType, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class typeOfResourceDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(typeOfResourceDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, typeOfResourceDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="typeOfResourceDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                ...
                namespaceprefix_,
                namespacedef_,
                name_="typeOfResourceDefinition",
                pretty_print=pretty_print,
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="typeOfResourceDefinition"
    ):
        super(typeOfResourceDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="typeOfResourceDefinition"
        )
        if self.collection != "yes" and "collection" not in already_processed:
            already_processed.add("collection")
            outfile.write(
                " collection=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.collection), input_name="collection")),)
            )
        if self.manuscript != "yes" and "manuscript" not in already_processed:
            already_processed.add("manuscript")
            outfile.write(
                " manuscript=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.manuscript), input_name="manuscript")),)
            )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(typeOfResourceDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class nonSort(stringPlusLanguage):
    ...
    def __init__(
        self, lang=None, script=None, transliteration=None, space=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, nonSort)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nonSort.subclass:
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(nonSort, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="nonSort", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="nonSort", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="nonSort"):
        ...
        if self.space is not None and "space" not in already_processed:
            ...
            outfile.write(
                " space=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.space), input_name="space")),)
            )
    ...
    def exportChildren(
        ...
        super(nonSort, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class targetAudienceDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(targetAudienceDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.displayLabel = _cast(None, displayLabel)
        self.displayLabel_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, targetAudienceDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="targetAudienceDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                ...
                namespaceprefix_,
                namespacedef_,
                name_="targetAudienceDefinition",
                pretty_print=pretty_print,
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="targetAudienceDefinition"
    ):
        super(targetAudienceDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="targetAudienceDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(targetAudienceDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class tableOfContentsDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, tableOfContentsDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            tableOfContentsDefinition, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="tableOfContentsDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="tableOfContentsDefinition"
    ):
        super(tableOfContentsDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="tableOfContentsDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.shareable != "no" and "shareable" not in already_processed:
            ...
            outfile.write(
                " shareable=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.shareable), input_name="shareable")),)
            )
        if self.altRepGroup is not None and "altRepGroup" not in already_processed:
            already_processed.add("altRepGroup")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(tableOfContentsDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class hierarchicalPart(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, hierarchicalPart)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(hierarchicalPart, self).hasContent_():
            return True
        else:
            return False

    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="hierarchicalPart", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="hierarchicalPart", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="hierarchicalPart"):
        super(hierarchicalPart, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="hierarchicalPart"
        )
        if self.level is not None and "level" not in already_processed:
            already_processed.add("level")
            outfile.write(
        ...
        if self.period is not None and "period" not in already_processed:
            ...
            outfile.write(
                " period=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.period), input_name="period")),)
            )
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
            outfile.write(
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="hierarchicalPart",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(hierarchicalPart, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class geographicCodeDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, geographicCodeDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="geographicCodeDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                ...
                namespaceprefix_,
                namespacedef_,
                name_="geographicCodeDefinition",
                pretty_print=pretty_print,
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="geographicCodeDefinition"
    ):
        super(geographicCodeDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="geographicCodeDefinition"
        )
        if self.authorityURI is not None and "authorityURI" not in already_processed:
            already_processed.add("authorityURI")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(geographicCodeDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class recordIdentifierDefinition(stringPlusLanguage):
    ...
    def __init__(
        self, lang=None, script=None, transliteration=None, source=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, recordIdentifierDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            recordIdentifierDefinition, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="recordIdentifierDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="recordIdentifierDefinition"
    ):
        super(recordIdentifierDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="recordIdentifierDefinition"
        )
    ...
    def exportChildren(
        ...
        super(recordIdentifierDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class physicalDescriptionNote(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, physicalDescriptionNote)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="physicalDescriptionNote", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="physicalDescriptionNote"):
        super(physicalDescriptionNote, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="physicalDescriptionNote"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.typeURI is not None and "typeURI" not in already_processed:
            ...
            outfile.write(
                " typeURI=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.typeURI), input_name="typeURI")),)
            )
        if self.ID is not None and "ID" not in already_processed:
            already_processed.add("ID")
            outfile.write(" ID=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.ID), input_name="ID")),))
    ...
    def exportChildren(
        ...
        super(physicalDescriptionNote, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class extent(stringPlusLanguagePlusSupplied):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, extent)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if extent.subclass:
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(extent, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="extent", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="extent", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportChildren(
        ...
        super(extent, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class text(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, text)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if text.subclass:
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(text, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="text", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="text", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportChildren(
        ...
        super(text, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class dateDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, dateDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(dateDefinition, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="dateDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="dateDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="dateDefinition"):
        super(dateDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="dateDefinition"
        )
        ...
        if self.qualifier is not None and "qualifier" not in already_processed:
            ...
            outfile.write(
                " qualifier=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.qualifier), input_name="qualifier")),)
            )
        if self.point is not None and "point" not in already_processed:
            already_processed.add("point")
            outfile.write(
                " point=%s" % (self.gds_encode(self.gds_format_string(quote_attrib(self.point), input_name="point")),)
            )
        if self.keyDate != "yes" and "keyDate" not in already_processed:
            already_processed.add("keyDate")
            outfile.write(
                " keyDate=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.keyDate), input_name="keyDate")),)
            )
        if self.calendar is not None and "calendar" not in already_processed:
            already_processed.add("calendar")
            outfile.write(
                " calendar=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.calendar), input_name="calendar")),)
            )
        if self.extensiontype_ is not None and "xsi:type" not in already_processed:
            already_processed.add("xsi:type")
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="dateDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(dateDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class publisherDefinition(stringPlusLanguagePlusSupplied):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, publisherDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="publisherDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="publisherDefinition"):
        super(publisherDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="publisherDefinition"
        )
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(publisherDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class placeTermDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, placeTermDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def validate_codeOrText(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on codeOrText'
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="placeTermDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="placeTermDefinition"):
        super(placeTermDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="placeTermDefinition"
        )
        if self.authorityURI is not None and "authorityURI" not in already_processed:
            already_processed.add("authorityURI")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(placeTermDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class noteDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, noteDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(noteDefinition, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="noteDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="noteDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="noteDefinition"):
        super(noteDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="noteDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="noteDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(noteDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class roleTermDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(roleTermDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, roleTermDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="roleTermDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="roleTermDefinition"):
        super(roleTermDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="roleTermDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(roleTermDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class namePartDefinition(stringPlusLanguage):
    ...
    def __init__(
        self, lang=None, script=None, transliteration=None, type_=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, namePartDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="namePartDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="namePartDefinition"):
        super(namePartDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="namePartDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(namePartDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class enumerationAndChronologyDefinition(stringPlusLanguage):
    ...
    def __init__(
        self, lang=None, script=None, transliteration=None, unitType=None, valueOf_=None, gds_collector_=None, **kwargs_
    ):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, enumerationAndChronologyDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            enumerationAndChronologyDefinition, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="enumerationAndChronologyDefinition",
        pretty_print=True,
    ):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="enumerationAndChronologyDefinition"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(self.convert_unicode(self.valueOf_))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="enumerationAndChronologyDefinition"
    ):
        super(enumerationAndChronologyDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="enumerationAndChronologyDefinition"
        )
        if self.unitType is not None and "unitType" not in already_processed:
            ...
            outfile.write(
                " unitType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.unitType), input_name="unitType")),)
            )
    ...
    def exportChildren(
        ...
        super(enumerationAndChronologyDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class formDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(formDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, formDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(formDefinition, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="formDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="formDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="formDefinition"):
        super(formDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="formDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="formDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(formDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class itemIdentifierDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, itemIdentifierDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="itemIdentifierDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                ...
                namespaceprefix_,
                namespacedef_,
                name_="itemIdentifierDefinition",
                pretty_print=pretty_print,
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="itemIdentifierDefinition"
    ):
        super(itemIdentifierDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="itemIdentifierDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(itemIdentifierDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class physicalLocationDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(physicalLocationDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.displayLabel = _cast(None, displayLabel)
        self.displayLabel_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, physicalLocationDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            physicalLocationDefinition, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="physicalLocationDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="physicalLocationDefinition"
    ):
        super(physicalLocationDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="physicalLocationDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(physicalLocationDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class scriptTermDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(scriptTermDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, scriptTermDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="scriptTermDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="scriptTermDefinition"):
        super(scriptTermDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="scriptTermDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(scriptTermDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class languageTermDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, languageTermDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="languageTermDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="languageTermDefinition"):
        super(languageTermDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="languageTermDefinition"
        )
        if self.authorityURI is not None and "authorityURI" not in already_processed:
            already_processed.add("authorityURI")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(languageTermDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class identifierDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, identifierDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="identifierDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="identifierDefinition"):
        super(identifierDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="identifierDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.invalid != "yes" and "invalid" not in already_processed:
            ...
            outfile.write(
                " invalid=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.invalid), input_name="invalid")),)
            )
        if self.altRepGroup is not None and "altRepGroup" not in already_processed:
            already_processed.add("altRepGroup")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(identifierDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class genreDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(genreDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, genreDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(genreDefinition, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="genreDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="genreDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="genreDefinition"):
        super(genreDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="genreDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="genreDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(genreDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class classificationDefinition(stringPlusLanguagePlusAuthority):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(classificationDefinition, self).__init__(
            lang, script, transliteration, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, classificationDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="classificationDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(
                ...
                namespaceprefix_,
                namespacedef_,
                name_="classificationDefinition",
                pretty_print=pretty_print,
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="classificationDefinition"
    ):
        super(classificationDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="classificationDefinition"
        )
        if self.edition is not None and "edition" not in already_processed:
            already_processed.add("edition")
            outfile.write(
                " edition=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.edition), input_name="edition")),)
            )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
        ...
        if self.generator is not None and "generator" not in already_processed:
            ...
            outfile.write(
                " generator=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.generator), input_name="generator")),)
            )
    ...
    def exportChildren(
        ...
        super(classificationDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class accessConditionDefinition(extensionDefinition):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(accessConditionDefinition, self).__init__(
            displayLabel, anytypeobjs_, valueOf_, mixedclass_, content_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
        self.altRepGroup = _cast(None, altRepGroup)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, accessConditionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(
            accessConditionDefinition, self
        ).hasContent_():
            return True
        else:
            return False
    ...
    def export(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="accessConditionDefinition",
        pretty_print=True,
    ):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespaceprefix_="", name_="accessConditionDefinition"
    ):
        super(accessConditionDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="accessConditionDefinition"
        )
        if self.type_ != "simple" and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(" type=%s" % (quote_attrib(self.type_),))
    ...
    def exportChildren(
        ...
        super(accessConditionDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
...
class abstractDefinition(stringPlusLanguage):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, abstractDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="abstractDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="abstractDefinition"):
        super(abstractDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="abstractDefinition"
        )
        if self.displayLabel is not None and "displayLabel" not in already_processed:
            already_processed.add("displayLabel")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(abstractDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class citySectionDefinition(hierarchicalPart):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(citySectionDefinition, self).__init__(
            lang, script, transliteration, level, period, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, citySectionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="citySectionDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="citySectionDefinition"):
        super(citySectionDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="citySectionDefinition"
        )
        if self.citySectionType is not None and "citySectionType" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_encode(
                        self.gds_format_string(quote_attrib(self.citySectionType), input_name="citySectionType")
                    ),
                )
            )
    ...
    def exportChildren(
        ...
        super(citySectionDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class regionDefinition(hierarchicalPart):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(regionDefinition, self).__init__(
            lang, script, transliteration, level, period, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, regionDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(regionDefinition, self).hasContent_():
            return True
        else:
            return False

    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="regionDefinition", pretty_print=True
    ):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="regionDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="regionDefinition"):
        super(regionDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="regionDefinition"
        )
        if self.regionType is not None and "regionType" not in already_processed:
            already_processed.add("regionType")
            outfile.write(
                " regionType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.regionType), input_name="regionType")),)
            )
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="regionDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(regionDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class areaDefinition(hierarchicalPart):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(areaDefinition, self).__init__(
            lang, script, transliteration, level, period, authority, authorityURI, valueURI, valueOf_, **kwargs_
        )
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, areaDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (1 if type(self.valueOf_) in [int, float] else self.valueOf_) or super(areaDefinition, self).hasContent_():
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespaceprefix_="", namespacedef_="", name_="areaDefinition", pretty_print=True):
        ...
        if self.hasContent_():
            ...
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(
                outfile, level + 1, namespaceprefix_, namespacedef_, name_="areaDefinition", pretty_print=pretty_print
            )
            outfile.write("</%s%s>%s" % (namespaceprefix_, name_, eol_))
        else:
            outfile.write("/>%s" % (eol_,))
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="areaDefinition"):
        super(areaDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="areaDefinition"
        )
        if self.areaType is not None and "areaType" not in already_processed:
            already_processed.add("areaType")
            outfile.write(
                " areaType=%s"
                % (self.gds_encode(self.gds_format_string(quote_attrib(self.areaType), input_name="areaType")),)
            )
    ...
    def exportChildren(
        ...
        namespaceprefix_="",
        namespacedef_="",
        name_="areaDefinition",
        fromsubclass_=False,
        pretty_print=True,
    ):
        super(areaDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class temporalDefinition(dateDefinition):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(temporalDefinition, self).__init__(
            lang, script, transliteration, encoding, qualifier, point, keyDate, calendar, valueOf_, **kwargs_
        )
        self.authority = _cast(None, authority)
        self.authority_nsprefix_ = None
        self.authorityURI = _cast(None, authorityURI)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, temporalDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="temporalDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="temporalDefinition"):
        super(temporalDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="temporalDefinition"
        )
        if self.authority is not None and "authority" not in already_processed:
            already_processed.add("authority")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(temporalDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
...
class dateOtherDefinition(dateDefinition):
    ...
    def __init__(
        ...
        **kwargs_,
        ...
        self.parent_object_ = kwargs_.get("parent_object_")
        self.ns_prefix_ = None
        super(dateOtherDefinition, self).__init__(
            lang, script, transliteration, encoding, qualifier, point, keyDate, calendar, valueOf_, **kwargs_
        )
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(CurrentSubclassModule_, dateOtherDefinition)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(
        self, outfile, level, namespaceprefix_="", namespacedef_="", name_="dateOtherDefinition", pretty_print=True
    ):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_="", name_="dateOtherDefinition"):
        super(dateOtherDefinition, self).exportAttributes(
            outfile, level, already_processed, namespaceprefix_, name_="dateOtherDefinition"
        )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.add("type_")
            outfile.write(
    ...
    def exportChildren(
        ...
        super(dateOtherDefinition, self).exportChildren(
            outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print
        )
        pass
